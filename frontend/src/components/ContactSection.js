      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <input
                  ...
                  className="w-full px-4 py-4 bg-gray-800/50 border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300"
                  required
                />
              </div>
              ...
              <div>
                <textarea
                  ...
                  rows="6"
                  className="w-full px-4 py-4 bg-gray-800/50 border border-gray-600/50 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300 resize-none"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-purple-500/25 flex items-center justify-center gap-2 font-medium"
              >
          ...
          <div className="space-y-6">
            {/* Map Section */}
            <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-2xl p-8 text-center min-h-[400px] flex flex-col items-center justify-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">My Living Area Map</h3>
                <p className="text-gray-300 text-sm mb-4">This can be drag with cursor</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">support@mail.com</p>
                  </div>
                </div>
