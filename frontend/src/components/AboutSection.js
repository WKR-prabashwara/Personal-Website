...
const AboutSection = () => {
  ...
  return (
    <section 
      id="about" 
      className="relative min-h-screen py-16 sm:py-20 bg-black overflow-hidden"
      aria-labelledby="about-heading"
    >
      {/* Enhanced Blurred Stars Background */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-xs sm:text-sm bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent flex items-center gap-2">
              <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-r from-purple-400 to-cyan-400 rounded-sm flex items-center justify-center flex-shrink-0">
                <Calculator className="w-2 h-2 sm:w-3 sm:h-3 text-white" aria-hidden="true" />
              </div>
        ...
        >
          ...
          >
            ...
            <div className="w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 bg-gray-900/50 border border-purple-500/30 rounded-2xl mb-6 sm:mb-8 overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm">
              <div className="w-full h-full bg-gradient-to-br from-purple-900/30 via-black/50 to-blue-900/30 flex items-center justify-center relative">
                {/* Profile photo placeholder with better accessibility */}
                <div 
                  className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 bg-gray-800/80 rounded-full flex items-center justify-center border-4 border-gray-700/50 shadow-inner"
                  role="img"
                  aria-label="Profile photo placeholder for Rivibibu Prabashwara"
                >
                  <User className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 text-gray-400" aria-hidden="true" />
                </div>
                ...
                <div className="absolute inset-0 border border-purple-500/20 rounded-2xl" aria-hidden="true"></div>
              </div>
            </div>
            ...
            <div className="text-center lg:text-left px-4 lg:px-0 max-w-md lg:max-w-none">
              ...
              <button 
                ...
                className="btn-primary px-6 sm:px-8 py-2 sm:py-3 text-sm sm:text-base font-medium focus:outline-none focus:ring-2 focus:ring-purple-400/50 focus:ring-offset-2 focus:ring-offset-black"
          ...
          >
            <article className="bg-gray-900/40 border border-purple-500/30 rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:bg-gray-900/60 transition-all duration-300">
              <header className="flex items-center mb-3 sm:mb-4">
                <Calculator className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-purple-400 mr-3 flex-shrink-0" aria-hidden="true" />
                <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-white">Academic Focus</h4>
              </header>
              <ul className="space-y-2 sm:space-y-3 text-gray-300" role="list">
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-purple-400 rounded-full mr-3 flex-shrink-0" aria-hidden="true"></span>
            ...
            <article className="bg-gray-900/40 border border-purple-500/30 rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:bg-gray-900/60 transition-all duration-300">
              <header className="flex items-center mb-3 sm:mb-4">
                <Code className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-cyan-400 mr-3 flex-shrink-0" aria-hidden="true" />
                <h4 className="text-base sm:text-lg lg:text-xl font-semibold text-white">Technical Skills</h4>
              </header>
              <ul className="space-y-2 sm:space-y-3 text-gray-300" role="list">
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-cyan-400 rounded-full mr-3 flex-shrink-0" aria-hidden="true"></span>
            ...
            <article className="bg-gray-900/40 border border-purple-500/30 rounded-2xl p-4 sm:p-6 backdrop-blur-sm hover:bg-gray-900/60 transition-all duration-300">
              <header className="flex items-center mb-3 sm:mb-4">
                <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-green-400 mr-3 flex-shrink-0" aria-hidden="true" />
